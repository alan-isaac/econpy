...
"   Initially based on syntax file by Steven Stoddard
...
syn region  nlogoCommentL start=";" end="$" keepend contains=nlogoTodo
...
syn keyword nlogoColorConstant black gray white red orange brown yellow green lime
