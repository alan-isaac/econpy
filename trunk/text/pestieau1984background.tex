...
So $E[a_t+1]$ should be govenened by (\ref{Pestieau3}), but is not.
...
- use (\ref{Pestieau3}) as basis of expected ability
...
\newpage
\begin{table}
\caption{Period $t$ Timing in Pestieau (1984) Simulation}
\centering
\begin{tabular}{rccc}\toprule
 {\bf Seq} & {\bf Young} &  {\bf Old} & {\bf Economy} \\ \midrule
